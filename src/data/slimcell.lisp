...
(defmethod learn-unique ((a slimcell) (constant-cell k))
  (multiple-value-bind (stencil mug)
    (slim-case a (meta)
      ((or null constant-cell) (values nil nil))
      (mug (values nil meta))
      (slimcore (values (slimcore-stencil meta) (slimcore-mug meta))))
    (when mug (learn-mug k mug))
    (when stencil (learn-stencil k stencil))
...
(defmethod learn-stencil ((a slimcell) (s stencil))
  (slim-case a (meta)
    (null (setf (slimcell-meta) (make-slimcore nil s)))
    (mug (setf (slimcell-meta) (make-slimcore meta s)))
    (slimcore nil)
...
(defun teach-smeta (a b)
  (slim-case a (meta)
    ...
    (slimcore (let (m (slimcore-mug meta))
